...
def mitigated_import_of_vanilla_custom_nodes() -> ExportedNodes:
    ...
    import hiddenswitch_comfy_extras
    for module_name, module in sys.modules.items():
        if not module_name.startswith("hiddenswitch_comfy_extras.nodes"):
            continue
        module_short_name = module_name.split(".")[-1]
        setattr(hiddenswitch_comfy_extras, module_short_name, module)
        comfy_extras_mitigation[f'hiddenswitch_comfy_extras.{module_short_name}'] = module
