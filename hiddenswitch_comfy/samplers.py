...
@_deprecate_method(version="0.0.2", message="The hiddenswitch_comfy.samplers.calc_cond_uncond_batch function is deprecated please use the calc_cond_batch one instead.")
...
@_deprecate_method(version="0.3.2", message="WARNING: The hiddenswitch_comfy.samplers.resolve_areas_and_cond_masks function is deprecated please use the resolve_areas_and_cond_masks_multidim one instead.")
