...
class ModelPatcher(ModelManageable):
    ...
    @_deprecate_method(version="0.3.2", message="WARNING the ModelPatcher.calculate_weight function is deprecated, please use: hiddenswitch_comfy.lora.calculate_weight instead")
