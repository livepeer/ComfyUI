...
def main():
    ...
    with as_file(files('hiddenswitch_comfy.api').joinpath('openapi.yaml')) as openapi_schema:
        with as_file(files('hiddenswitch_comfy.api').joinpath('openapi_python_config.yaml')) as python_config:
            cmds = [
                "java",
