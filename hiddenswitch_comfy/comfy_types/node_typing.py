...
class InputTypeOptions(TypedDict):
    ...
    Comfy Docs: https://docs.hiddenswitch_comfy.org/custom-nodes/backend/datatypes
    """
...
class InputTypeDict(TypedDict):
    ...
    Comfy Docs: https://docs.hiddenswitch_comfy.org/custom-nodes/backend/more_on_inputs
    """
    ...
    Comfy Docs: https://docs.hiddenswitch_comfy.org/custom-nodes/backend/more_on_inputs#hidden-inputs
    """
...
class ComfyNodeABC(ABC):
    ...
    Comfy Docs: https://docs.hiddenswitch_comfy.org/custom-nodes/backend/server_overview
    """
    ...
    Comfy Docs: https://docs.hiddenswitch_comfy.org/custom-nodes/backend/server_overview#category
    """
    EXPERIMENTAL: bool
    ...
    def INPUT_TYPES(s) -> InputTypeDict:
        ...
        * The ``hidden`` key offers some advanced functionality.  More info at: https://docs.hiddenswitch_comfy.org/custom-nodes/backend/more_on_inputs#hidden-inputs

        Comfy Docs: https://docs.hiddenswitch_comfy.org/custom-nodes/backend/server_overview#input-types
        """
        return {"required": {}}
    ...
    Comfy Docs: https://docs.hiddenswitch_comfy.org/custom-nodes/backend/server_overview#output-node
    """
    INPUT_IS_LIST: bool
    ...
    Comfy Docs: https://docs.hiddenswitch_comfy.org/custom-nodes/backend/lists#list-processing
    """
    ...
    Comfy Docs: https://docs.hiddenswitch_comfy.org/custom-nodes/backend/server_overview#return-types
    """
    RETURN_NAMES: tuple[str]
    """The output slot names for each item in `RETURN_TYPES`, e.g. ``RETURN_NAMES = ("count", "filter_string")``

    Comfy Docs: https://docs.hiddenswitch_comfy.org/custom-nodes/backend/server_overview#return-names
    """
    ...
    Comfy Docs: https://docs.hiddenswitch_comfy.org/custom-nodes/backend/server_overview#function
    """
...
class CheckLazyMixin:
    ...
    def check_lazy_status(self, **kwargs) -> list[str]:
        ...
        Comfy Docs: https://docs.hiddenswitch_comfy.org/custom-nodes/backend/lazy_evaluation#defining-check-lazy-status
        """
