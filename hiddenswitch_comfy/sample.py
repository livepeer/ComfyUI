...
@_deprecate_method(version="0.3.2", message="Warning: hiddenswitch_comfy.sample.prepare_sampling isn't used anymore and can be removed")
def prepare_sampling(model, noise_shape, positive, negative, noise_mask):
    pass
    return model, positive, negative, noise_mask, []

@_deprecate_method(version="0.3.2", message="Warning: hiddenswitch_comfy.sample.cleanup_additional_models isn't used anymore and can be removed")
