...
from hiddenswitch_comfy.cldm.control_types import UNION_CONTROLNET_TYPES
from hiddenswitch_comfy.nodes.base_nodes import ControlNetApplyAdvanced
...
class ControlNetInpaintingAliMamaApply(ControlNetApplyAdvanced):
    ...
    def apply_inpaint_controlnet(self, positive, negative, control_net, vae, image, mask, strength, start_percent, end_percent):
        ...
        if control_net.concat_mask:
            ...
            mask_apply = hiddenswitch_comfy.utils.common_upscale(mask, image.shape[2], image.shape[1], "bilinear", "center").round()
