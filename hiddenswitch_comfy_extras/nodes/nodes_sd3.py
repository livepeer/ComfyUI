...
from hiddenswitch_comfy.model_downloader import get_or_download, get_filename_list_with_downloadable, KNOWN_CLIP_MODELS
...
class TripleCLIPLoader:
    ...
    def load_clip(self, clip_name1, clip_name2, clip_name3):
        ...
        clip = hiddenswitch_comfy.sd.load_clip(ckpt_paths=[clip_path1, clip_path2, clip_path3], embedding_directory=folder_paths.get_folder_paths("embeddings"))
        return (clip,)


class EmptySD3LatentImage:
    def __init__(self):
        self.device = hiddenswitch_comfy.model_management.intermediate_device()
