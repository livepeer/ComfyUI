...
from hiddenswitch_comfy import model_downloader
...
class QuadrupleCLIPLoader:
    ...
    def load_clip(self, clip_name1, clip_name2, clip_name3, clip_name4):
        ...
        clip = hiddenswitch_comfy.sd.load_clip(ckpt_paths=[clip_path1, clip_path2, clip_path3, clip_path4], embedding_directory=folder_paths.get_folder_paths("embeddings"))
        return (clip,)
