...
class SkeletonizeThin:
    ...
    def process_image(self, image, binary_threshold, approach):
        ...
        device = hiddenswitch_comfy.model_management.intermediate_device()
        ...
        final_result = torch.stack(results).to(hiddenswitch_comfy.model_management.intermediate_device())
        return (final_result,)
