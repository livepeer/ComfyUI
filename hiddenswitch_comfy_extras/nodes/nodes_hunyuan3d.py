...
import struct
import numpy as np
from hiddenswitch_comfy.ldm.modules.diffusionmodules.mmdit import get_1d_sincos_pos_embed_from_grid_torch
...
class EmptyLatentHunyuan3Dv2:
    ...
    def generate(self, resolution, batch_size):
        latent = torch.zeros([batch_size, 64, resolution], device=hiddenswitch_comfy.model_management.intermediate_device())
...
def voxel_to_mesh_surfnet(voxels, threshold=0.5, device=None):
    ...
    cell_vertices = {}
    progress = hiddenswitch_comfy.utils.ProgressBar(100)
