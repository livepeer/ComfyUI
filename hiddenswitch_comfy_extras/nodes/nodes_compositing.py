...
from hiddenswitch_comfy.component_model.tensor_types import RGBImageBatch, ImageBatch, MaskBatch
    ...
    def composite(self, source: RGBImageBatch, destination: RGBImageBatch, mode, source_alpha: MaskBatch = None, destination_alpha: MaskBatch = None) -> tuple[RGBImageBatch, MaskBatch]:
        ...
        for i in range(batch_size):
            ...
            if dst_alpha.shape[:2] != dst_image.shape[:2]:
                ...
                upscale_output = hiddenswitch_comfy.utils.common_upscale(upscale_input, dst_image.shape[1], dst_image.shape[0], upscale_method='bicubic', crop='center')
            ...
            if src_alpha.shape != dst_alpha.shape:
                ...
                upscale_output = hiddenswitch_comfy.utils.common_upscale(upscale_input, dst_alpha.shape[1], dst_alpha.shape[0], upscale_method='bicubic', crop='center')
