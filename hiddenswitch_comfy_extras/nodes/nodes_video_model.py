...
from hiddenswitch_comfy.model_downloader import get_filename_list_with_downloadable, KNOWN_IMAGE_ONLY_CHECKPOINTS, get_or_download
...
class ImageOnlyCheckpointLoader:
    ...
    def load_checkpoint(self, ckpt_name, output_vae=True, output_clip=True):
        ...
        out = hiddenswitch_comfy.sd.load_checkpoint_guess_config(ckpt_path, output_vae=True, output_clip=False, output_clipvision=True, embedding_directory=folder_paths.get_folder_paths("embeddings"))
...
class SVD_img2vid_Conditioning:
    ...
    def encode(self, clip_vision, init_image, vae, width, height, video_frames, motion_bucket_id, fps, augmentation_level):
        ...
        pixels = hiddenswitch_comfy.utils.common_upscale(init_image.movedim(-1, 1), width, height, "bilinear", "center").movedim(1, -1)
