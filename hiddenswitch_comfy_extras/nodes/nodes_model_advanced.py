...
import hiddenswitch_comfy.model_sampling
import hiddenswitch_comfy.sd
from hiddenswitch_comfy import node_helpers
from hiddenswitch_comfy.nodes.common import MAX_RESOLUTION


class LCM(hiddenswitch_comfy.model_sampling.EPS):
...
class ModelSamplingDiscreteDistilled(hiddenswitch_comfy.model_sampling.ModelSamplingDiscrete):
...
class ModelSamplingDiscrete:
    ...
    def patch(self, model, sampling, zsnr):
        ...
        sampling_type = "eps"
        sampling_base = hiddenswitch_comfy.model_sampling.ModelSamplingDiscrete
        if sampling == "eps":
            sampling_type = hiddenswitch_comfy.model_sampling.EPS
        elif sampling == "v_prediction":
            sampling_type = hiddenswitch_comfy.model_sampling.V_PREDICTION
        elif sampling == "lcm":
            sampling_type = LCM
            sampling_base = ModelSamplingDiscreteDistilled
        elif sampling == "x0":
            sampling_type = hiddenswitch_comfy.model_sampling.X0
        elif sampling == "img_to_img":
            sampling_type = hiddenswitch_comfy.model_sampling.IMG_TO_IMG
...
class ModelSamplingStableCascade:
    ...
    def patch(self, model, shift):
        ...
        sampling_base = hiddenswitch_comfy.model_sampling.StableCascadeSampling
        sampling_type = hiddenswitch_comfy.model_sampling.EPS
...
class ModelSamplingSD3:
    ...
    def patch(self, model, shift, multiplier=1000):
        ...
        sampling_base = hiddenswitch_comfy.model_sampling.ModelSamplingDiscreteFlow
        sampling_type = hiddenswitch_comfy.model_sampling.CONST
...
class ModelSamplingFlux:
    ...
    def patch(self, model, max_shift, base_shift, width, height):
        ...
        sampling_base = hiddenswitch_comfy.model_sampling.ModelSamplingFlux
        sampling_type = hiddenswitch_comfy.model_sampling.CONST
...
class ModelSamplingContinuousEDM:
    ...
    def patch(self, model, sampling, sigma_max, sigma_min):
        ...
        if sampling == "eps":
            ...
            sampling_type = hiddenswitch_comfy.model_sampling.EDM
            sigma_data = 0.5
        elif sampling == "v_prediction":
            sampling_type = hiddenswitch_comfy.model_sampling.V_PREDICTION
            ...
            sampling_type = hiddenswitch_comfy.model_sampling.EDM
            sigma_data = 0.5
            latent_format = hiddenswitch_comfy.latent_formats.SDXL_Playground_2_5()

        class ModelSamplingAdvanced(hiddenswitch_comfy.model_sampling.ModelSamplingContinuousEDM, sampling_type):
            pass
...
class ModelSamplingContinuousV:
    ...
    def patch(self, model, sampling, sigma_max, sigma_min):
        ...
        class ModelSamplingAdvanced(hiddenswitch_comfy.model_sampling.ModelSamplingContinuousV, sampling_type):
            pass
