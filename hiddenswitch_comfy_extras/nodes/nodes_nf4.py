...
import hiddenswitch_comfy.ops
import hiddenswitch_comfy.sd
from hiddenswitch_comfy.cmd.folder_paths import get_folder_paths
from hiddenswitch_comfy.model_downloader import get_filename_list_with_downloadable, get_or_download
...
class OPS(hiddenswitch_comfy.ops.manual_cast):
...
class CheckpointLoaderNF4:
    ...
    def load_checkpoint(self, ckpt_name):
        ...
        out = hiddenswitch_comfy.sd.load_checkpoint_guess_config(ckpt_path, output_vae=True, output_clip=True, embedding_directory=get_folder_paths("embeddings"), model_options={"custom_operations": OPS})
        return out[:3]
